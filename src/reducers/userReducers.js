...
const userInfoReducer = (state = initialStateUserInfo, action) => {
  switch (action.type) {
    ...
    //Delete group all
    case constants.DELETE_GROUP_SELECTED_ROWS_REUEST:
      return { ...state, isLoading: true, groupDeletedAll: false };
    case constants.DELETE_GROUP_SELECTED_ROWS_SUCCESS:
      return {
        ...state,
        isLoading: false,
        groupDeletedAll: true,
      };
    case constants.DELETE_GROUP_SELECTED_ROWS_FAIL:
      return { ...state, isLoading: false, errorMessageGroup: action.payload };
