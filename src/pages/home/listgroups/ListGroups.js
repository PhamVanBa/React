...
const ListGroups = (props) => {
  ...
  const handleClickDeleteAll = (item) => {
    console.log(item);
    props.groupDeletedAll(item.id);
  };
  ...
  useEffect(() => {
    ...
    props.createdGroupSuccessfully,
    props.groupDeleted,
    props.groupDeletedAll,
  ]);
  ...
  return (
    <div className="list-groups">
      <div className="content">
        {props.formGroupIsOpen && (
          <FormGroupInfo groupItem={groupItem} buttonText={buttonText} />
        )}
...
const mapStateToProps = (state) => {
  return {
    ...
    groupDeletedAll: state.userInfo.groupDeletedAll,
    pageNumber: state.userInfo.pageNumber,
    pageSize: state.userInfo.pageSize,
    // totalElement: state.userInfo.totalElement,
  };
};
...
const mapDispatchToProps = (dispatch, props) => {
  return {
    ...
    deleteGroupAll: (id) => {
      dispatch(userActions.deleteGroupAll(id));
    },
  };
};
